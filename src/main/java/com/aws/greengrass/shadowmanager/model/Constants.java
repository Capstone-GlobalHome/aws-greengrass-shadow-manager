...
public final class Constants {
    ...
    public static final String NAMED_SHADOW_RABBIT_ROUTING_PREFIX = "%s.%s";
    ...
    public static final String LOG_RABBIT_HOST_KEY = "host";
    public static final String LOG_RABBIT_CHANNEL_KEY = "channel";
    public static final String LOG_RABBIT_EXCHANGE_KEY = "exchange";
    public static final String LOG_RABBIT_EXCHANGE_TYPE_KEY = "type";
    public static final String LOG_RABBIT_DURABILITY_KEY = "durable";
    public static final String LOG_RABBIT_QUEUE_KEY = "queue";
